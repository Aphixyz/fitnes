...
export default function RegistrationForm({ trainerId, trainerInfo }) {
  ...
  const handleChange = (e) => {
    ...
    // เคลียร์ error เมื่อผู้ใช้แก้ไขข้อมูล
    if (errors[name]) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      delete submitData.confirm_password; // ไม่ส่งข้อมูลยืนยันรหัสผ่านไปยัง server
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select 
                ...
                onValueChange={(value) => handleSelectChange("member_gender", value)}
              >
