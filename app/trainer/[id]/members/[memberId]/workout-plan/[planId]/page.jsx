...
import { Edit, ArrowLeft, Calendar, Users, Dumbbell } from "lucide-react";
import Link from "next/link";

export default function MemberWorkoutPlanDetailsPage() {
  ...
  const memberName = `${plan.member_firstname} ${plan.member_lastname}`;
