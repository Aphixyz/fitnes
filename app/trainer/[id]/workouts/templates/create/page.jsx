  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        router.push(`/trainer/${trainerId}/workouts/templates/${result.template_id}`);
      } else {
        toast({
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="template_name">ชื่อเทมเพลต <span className="text-red-500">*</span></Label>
              <Input
                id="template_name"
                name="template_name"
            ...
            <div className="text-sm text-muted-foreground bg-blue-50 p-4 rounded-md">
              <p>เทมเพลตนี้จะถูกสร้างโดยไม่มีท่าออกกำลังกาย คุณสามารถเพิ่มท่าออกกำลังกายได้ในขั้นตอนถัดไป</p>
            </div>
          </CardContent>
