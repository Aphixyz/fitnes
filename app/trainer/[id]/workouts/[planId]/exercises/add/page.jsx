                  ...
                  <div className="border rounded-lg p-4 bg-slate-50">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                      ...
                      <div>
                        ...
                        <span className="text-muted-foreground">
                          {selectedExercise.equipment?.join(", ") || "ไม่ใช้อุปกรณ์"}
                        </span>
                      </div>
                      <div>
                        <span className="font-medium">ระดับความยาก:</span>{" "}
                        <span className="text-muted-foreground">
                          {selectedExercise.difficulty === "beginner" ? "เริ่มต้น" : 
                           selectedExercise.difficulty === "intermediate" ? "ปานกลาง" : 
                           selectedExercise.difficulty === "advanced" ? "ขั้นสูง" : 
