...
import { getPlanExercises, updatePlanExercise, getAllExercises } from "@/actions/trainer/(workout)/workoutExerciseActions";
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (!exercisesResult.success) {
          toast({
            title: "เกิดข้อผิดพลาด",
            description: exercisesResult.message || "ไม่สามารถดึงข้อมูลท่าออกกำลังกายได้",
            variant: "destructive",
          });
          router.back();
          return;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        router.push(`/trainer/${trainerId}/workouts/${planId}`);
      } else {
        toast({
          title: "เกิดข้อผิดพลาด",
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => handleSelectChange("exercise_day", value)}
                >
                  ...
                  <SelectContent>
                    ...
                    {plan.workout_days && plan.workout_days.split(",").map(day => (
            ...
            {exerciseInfo && (
              <div className="border rounded-lg p-4 bg-slate-50">
                <h3 className="text-sm font-medium mb-2">ข้อมูลท่าออกกำลังกาย</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                  ...
                  <div>
                    ...
                    <span className="text-muted-foreground">
                      {exerciseInfo.difficulty === "beginner" ? "เริ่มต้น" : 
                       exerciseInfo.difficulty === "intermediate" ? "ปานกลาง" : 
                       exerciseInfo.difficulty === "advanced" ? "ขั้นสูง" : 
