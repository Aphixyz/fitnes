...
export default function MealPlanForm({
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      if (mode === "create") {
        ...
        // แก้ไขมื้ออาหาร
        result = await updateMeal(mealData.meal_plan_id, formData, trainerId);
      }
  ...
  const handleDelete = async () => {
    setLoading(true);
    try {
      const result = await deleteMeal(mealData.meal_plan_id, trainerId);
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-[500px] mx-auto">
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                {errors.meal_name && (
                  <p className="text-sm text-red-500">{errors.meal_name}</p>
                )}
              </div>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center">
          <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-[400px] mx-auto">
            ...
            <p className="text-sm text-gray-500 mt-2 mb-6">
              การลบมื้ออาหารนี้จะลบข้อมูลอาหารทั้งหมดในมื้อนี้ด้วย
